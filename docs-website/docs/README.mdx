...
:::info
This project is not dead yet. Your feedback and contributions are valuable for its improvement.
:::
...
:::tip
For detailed installation instructions and recommended configurations, please refer to our [Prerequisites Setup Guide](./prerequisistes-setup.md).
:::
...
For detailed instructions on setting up the testing environment and running tests check out our [Testing Guide](./run-tests.md).
...
:::caution
End-to-end tests require additional setup. See the [Testing Guide](./run-tests.md) for details.
:::
...
For detailed deployment instructions, including local Docker deployment and server deployment guidelines, please refer to our [Deployment Guide](./deployment.md).
